 ...
 * aggreagtion information for the group of all rows. Each level of the tree (except for the root
 ...
 * {"John", 19}, {"Sarah", 2222}).
 * 
 * The aggregation data stored is all aggregation data possible for the columns to aggreagte (also
